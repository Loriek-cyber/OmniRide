...
public class BigliettiDAO {
    ...
    public static Long create(Biglietto nuovoBiglietto) throws SQLException {
        String sql = "INSERT INTO biglietto (id_utente, id_tratta, data_acquisto, stato, prezzo_pagato) VALUES (?, ?, ?, ?, ?)";
        try (Connection conn = DBConnector.getConnection();
            ...
            ps.setDouble(6, nuovoBiglietto.getPrezzoPagato());
